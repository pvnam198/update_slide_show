package com.example.slide.ui.edit_image.crop.view;
...
import com.example.slide.ui.edit_image.crop.request.CropRequest;
import com.example.slide.ui.edit_image.crop.request.LoadRequest;
import com.example.slide.ui.edit_image.crop.request.SaveRequest;
import com.example.slide.ui.edit_image.crop.animation.SimpleValueAnimator;
import com.example.slide.ui.edit_image.crop.animation.SimpleValueAnimatorListener;
import com.example.slide.ui.edit_image.crop.animation.ValueAnimatorV14;
import com.example.slide.ui.edit_image.crop.animation.ValueAnimatorV8;
import com.example.slide.ui.edit_image.crop.callback.Callback;
import com.example.slide.ui.edit_image.crop.callback.CropCallback;
import com.example.slide.ui.edit_image.crop.callback.LoadCallback;
import com.example.slide.ui.edit_image.crop.callback.SaveCallback;
import com.example.slide.ui.edit_image.crop.utils.Utils;
...
public class CropImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private int scaleVertical = 1;
    private int scaleHorizontal = 1;
    ...
    private void setMatrix() {
        ...
        mMatrix.postScale(mScale * scaleHorizontal, mScale * scaleVertical, mCenter.x, mCenter.y);
    ...
    private Bitmap getRotatedBitmap(Bitmap bitmap) {
        ...
        //mMatrix.setTranslate(mCenter.x - mImgWidth * 0.5f, mCenter.y - mImgHeight * 0.5f);
        rotateMatrix.postScale(scaleHorizontal, scaleVertical,centerWidth, centerHeight);
        rotateMatrix.postRotate(mAngle, centerWidth, centerHeight);
        //mMatrix.postRotate(mAngle, mCenter.x, mCenter.y);
   ...
   /* Matrix matrix = new Matrix();
    ...
    setupLayout(mViewWidth, mViewHeight);*/
        scaleHorizontal = -1 * scaleHorizontal;
        setMatrix();
        invalidate();
    }

...
public class BitmapFloatingItemIcon extends DrawableFloatingItem implements StickerIconEvent {
  ...
  public BitmapFloatingItemIcon(Drawable drawable, @Gravity int gravity, String tag) {
    super(drawable);

...
import com.example.slide.ui.edit_image.events.StickerIconEvent;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;


public class BitmapTextFloatingItemIcon extends DrawableFloatingItem implements StickerIconEvent {
  ...
  public BitmapTextFloatingItemIcon(Drawable drawable, @Gravity int gravity, String tag) {
    super(drawable);

...
public abstract class FloatingItem {
    ...
    @NonNull
    public FloatingItem setFlippedHorizontally(boolean flippedHorizontally) {
    ...
    @NonNull
    public FloatingItem setFlippedVertically(boolean flippedVertically) {
    ...
    public FloatingItem setMatrix(@Nullable Matrix matrix) {
    ...
    public abstract FloatingItem setDrawable(@NonNull Drawable drawable);

    @NonNull
    public abstract Drawable getDrawable();

    @NonNull
    public abstract FloatingItem setAlpha(@IntRange(from = 0, to = 255) int alpha);
    ...
    public void getMatrixValues(@NonNull Matrix matrix) {
      matrix.getValues(matrixValues);
    }

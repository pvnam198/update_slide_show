...
import com.example.slide.ui.edit_image.framework.DrawableFloatingItem;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;

public class BitmapActionIcon extends DrawableFloatingItem implements ActionEvent{
  ...
  private ActionEvent iconEvent;

  public BitmapActionIcon(Drawable drawable, @Gravity int gravity, String tag) {
    super(drawable);
  ...
  @Override
  public void onActionDown(TextListToVideoView stickerView, MotionEvent event) {
    if (iconEvent != null) {
  ...
  @Override
  public void onActionMove(TextListToVideoView stickerView, MotionEvent event) {
    if (iconEvent != null) {
  ...
  @Override
  public void onActionUp(TextListToVideoView stickerView, MotionEvent event) {
    if (iconEvent != null) {
      iconEvent.onActionUp(stickerView, event);
    }
  }

  public ActionEvent getIconEvent() {
    return iconEvent;
  }

  public void setIconEvent(ActionEvent iconEvent) {

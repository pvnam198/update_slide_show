package com.example.slide.framework.cutter;
...
public abstract class CheapSoundFile {
    ...
    public void WriteFileWithTime(File outputFile, int startTime, int endTime)
            throws java.io.IOException {

        int mSampleRate = getSampleRate();
        int mSamplesPerFrame = getSamplesPerFrame();
        int startFrame = (int) (1.0 * startTime * mSampleRate / mSamplesPerFrame + 0.5);
        int endFrame = (int) (1.0 * endTime * mSampleRate / mSamplesPerFrame + 0.5);
        WriteFile(outputFile,startFrame,endFrame-startFrame);
    }

    public abstract void WriteFile(File outputFile, int startFrame, int numFrames) throws java.io.IOException;
};